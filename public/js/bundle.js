...
})(
  {
    ...
    "../../node_modules/axios/lib/helpers/sanitizeHeaderValue.js": [
      function (require, module, exports) {
        ...
        exports.sanitizeHeaderValue = exports.sanitizeByteStringHeaderValue =
          void 0;
      ...
      function (require, module, exports) {
        ...
        function normalizeValue(value) {
          ...
          return _utils.default.isArray(value)
            ...
            : (0, _sanitizeHeaderValue.sanitizeHeaderValue)(String(value));
        }
        ...
        class AxiosHeaders {
          ...
          set(header, valueOrRewrite, rewrite) {
            ...
            if (
              ...
              _utils.default.isSafeIterable(header)
            ) {
              ...
              for (const entry of header) {
                ...
                if (_utils.default.hasOwnProp(obj, key)) {
                  dest = obj[key];
                  obj[key] = _utils.default.isArray(dest)
                    ? [...dest, entry[1]]
                    : [dest, entry[1]];
                } else {
                  obj[key] = entry[1];
      ...
      function (require, module, exports) {
        ...
        class AxiosError extends Error {
          ...
          toJSON() {
            ...
            const redactKeys =
              config && _utils.default.hasOwnProp(config, "redact")
                ? config.redact
                : undefined;
            const serializedConfig =
              _utils.default.isArray(redactKeys) && redactKeys.length > 0
                ? redactConfig(config, redactKeys)
                : _utils.default.toJSONObject(config);
            return {
              // Standard
 ...
 */
    ...
    "../../node_modules/axios/lib/helpers/toFormData.js": [
      function (require, module, exports) {
        ...
        const DEFAULT_FORM_DATA_MAX_DEPTH =
          (exports.DEFAULT_FORM_DATA_MAX_DEPTH = 100);
        ...
        function toFormData(obj, formData, options) {
            ...
            if (depth > maxDepth) {
              throw new _AxiosError.default(
                "Object is too deeply nested (" +
                  ...
                  " levels). Max depth: " +
                  maxDepth,
                _AxiosError.default.ERR_FORM_DATA_DEPTH_EXCEEDED,
              );
            }
          }
          ...
          function defaultVisitor(value, key, path) {
            let arr = value;
            if (
              _utils.default.isReactNative(formData) &&
              _utils.default.isReactNativeBlob(value)
            ) {
    ...
    "../../node_modules/axios/lib/helpers/buildURL.js": [
      function (require, module, exports) {
        ...
        var _AxiosURLSearchParams = _interopRequireDefault(
          require("./AxiosURLSearchParams.js"),
        );
        function _interopRequireDefault(e) {
          return e && e.__esModule ? e : { default: e };
        }
        ...
        function buildURL(url, params, options) {
          ...
          const _encode =
            _utils.default.getSafeProp(_options, "encode") || encode;
          ...
          if (serializeFn) {
            ...
            serializedParams = _utils.default.isURLSearchParams(params)
              ? params.toString()
              : new _AxiosURLSearchParams.default(params, _options).toString(
                  _encode,
                );
          }
          if (serializedParams) {
          ...
          function buildPath(path, value, target, index) {
            ...
            if (isLast) {
              if (_utils.default.hasOwnProp(target, name)) {
                target[name] = _utils.default.isArray(target[name])
            ...
            if (
              !_utils.default.hasOwnProp(target, name) ||
    ...
    "../../node_modules/axios/lib/defaults/index.js": [
      function (require, module, exports) {
        ...
        const own = (obj, key) =>
          obj != null && _utils.default.hasOwnProp(obj, key)
            ? obj[key]
            : undefined;
        ...
        function assertValidHttpProtocolURL(url, config) {
          if (
            ...
            throw new _AxiosError.default(
              ...
              _AxiosError.default.ERR_INVALID_URL,
              config,
            );
          }
        }
      ...
      function (require, module, exports) {
        ...
        function mergeConfig(config1, config2) {
          ...
          function getMergedTransitionalOption(prop) {
            const transitional2 = _utils.default.hasOwnProp(
              config2,
              "transitional",
            )
            ...
            const transitional1 = _utils.default.hasOwnProp(
              config1,
              "transitional",
            )
              ...
              : undefined;
            if (
              _utils.default.isPlainObject(transitional1) &&
              _utils.default.hasOwnProp(transitional1, prop)
            ) {
          ...
          _utils.default.forEach(
            ...
            function computeConfigValue(prop) {
              if (
                ...
                return;
              const merge = _utils.default.hasOwnProp(mergeMap, prop)
                ? mergeMap[prop]
                : mergeDeepProperties;
              const a = _utils.default.hasOwnProp(config1, prop)
                ? config1[prop]
                : undefined;
              const b = _utils.default.hasOwnProp(config2, prop)
                ? config2[prop]
                : undefined;
          ...
          if (
            _utils.default.hasOwnProp(config2, "validateStatus") &&
            _utils.default.isUndefined(config2.validateStatus) &&
    ...
    "../../node_modules/axios/lib/helpers/resolveConfig.js": [
      function (require, module, exports) {
        ...
        function resolveConfig(config) {
          ...
          const own = (key) =>
            _utils.default.hasOwnProp(newConfig, key)
              ? newConfig[key]
              : undefined;
          const data = own("data");
          ...
          if (_utils.default.isFormData(data)) {
            if (
              ...
              _utils.default.isReactNative(data)
            ) {
          ...
          function (config) {
            return new Promise(function dispatchXhrRequest(resolve, reject) {
              ...
              if ("setRequestHeader" in request) {
                _utils.default.forEach(
                  (0, _sanitizeHeaderValue.toByteStringHeaderObject)(
                    requestHeaders,
                  ),
    ...
    "../../node_modules/axios/lib/adapters/fetch.js": [
      function (require, module, exports) {
        ...
        var _settle = _interopRequireDefault(require("../core/settle.js"));
        var _estimateDataURLDecodedBytes = _interopRequireDefault(
          require("../helpers/estimateDataURLDecodedBytes.js"),
        );
        ...
        const factory = (env) => {
          const globalObject =
            _utils.default.global !== undefined &&
            _utils.default.global !== null
          ...
          return async (config) => {
            ...
            const hasMaxContentLength =
              _utils.default.isNumber(maxContentLength) &&
              maxContentLength > -1;
            const hasMaxBodyLength =
              _utils.default.isNumber(maxBodyLength) && maxBodyLength > -1;
            const own = (key) =>
              _utils.default.hasOwnProp(config, key) ? config[key] : undefined;
            ...
            try {
              ...
              if (configAuth) {
                const username =
                  _utils.default.getSafeProp(configAuth, "username") || "";
                const password =
                  _utils.default.getSafeProp(configAuth, "password") || "";
                auth = {
                  username,
                  password,
                };
              ...
              if (
                ...
                const estimated = (0, _estimateDataURLDecodedBytes.default)(
                  url,
                );
              ...
              const resolvedOptions = {
                ...
                headers: (0, _sanitizeHeaderValue.toByteStringHeaderObject)(
                  headers.normalize(),
                ),
                body: data,
                duplex: "half",
              ...
              if (hasMaxContentLength) {
                const declaredLength = _utils.default.toFiniteNumber(
              ...
              if (
                ...
                composedSignal.reason instanceof _AxiosError.default
              ) {
            ...
            Axios.prototype[method] = function (url, config) {
              return this.request(
                (0, _mergeConfig.default)(config || {}, {
                  ...
                  url,
                  data:
                    config && _utils.default.hasOwnProp(config, "data")
                      ? config.data
                      : undefined,
                }),
              );
      ...
      function (require, module, exports) {
        ...
        const logout = async () => {
          try {
            ...
            if (res.data.status === "success") {
              console.log(res.data.status);
              (0, _alert.showAlert)("success", "you are logout successfully!");
              window.setTimeout(() => {
                location.assign("/");
              }, 1500);
            }
      ...
      function (require, module, exports) {
        ...
        const bookTour = async (tourId) => {
          try {
            ...
            console.error(err);
            (0, _alert.showAlert)("error", "Payment initialization failed");
          }
        };
    ...
    "index.js": [
      function (require, module, exports) {
        ...
        const editReviewCloseBtn = document.querySelector(
          ".review-modal__close",
        );
        const editReviewOverlay = document.querySelector(
