...
const bookTour = async tourId => {
  try {
    ...
    const res = await (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId));
...
if (editReviewCloseBtn) editReviewCloseBtn.addEventListener("click", closeEditReviewModal);
if (editReviewOverlay) editReviewOverlay.addEventListener("click", closeEditReviewModal);
if (editReviewForm) editReviewForm.addEventListener("submit", e => {
  e.preventDefault();
